<div class="todos index">
	...
	<h2><?php echo $this->Html->image('todolist.png', array('alt' => 'Todolist'))?>  <?php echo __('Todos') . ' - Searchresults'; ?></h2>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('New Status'), array('controller' => 'statuses', 'action' => 'add')); ?> </li>
                ...
                <hr />
                <br />
                <li><?php echo $this->Html->link(__('Suche Todo', true), array('action' => 'sucheleer')); ?></li>
	</ul>
</div>
