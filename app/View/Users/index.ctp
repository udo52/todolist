<div class="users index">
	<h2><?php echo $this->Html->image('listusers.png', array('alt' => 'Unternehmen'))?>  <?php echo __('Users'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('name',__('Benutzername')); ?></th>
			...
			<th><?php echo $this->Paginator->sort('password',_('password')); ?></th>
